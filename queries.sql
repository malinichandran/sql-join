...
count(*) AS COUNT  FROM owners o JOIN
...
--   than 10000. 
SELECT o.first_name, o.last_name, AVG(v.price) AS average_price, count(v.owner_id) FROM owners o
JOIN vehicles V ON o.id= v.owner_id 
GROUP BY o.id HAVING count(v.owner_id)>1 AND AVG(price)>10000 
